...
struct Ads_Job
{
	...
	virtual int run() = 0;
	/* zxliu added: plesae keep the type value be 1 or equal to the TYPE_JOB in Forecast_Adaptive_Service.h */
...
public:
	...
	/* zxliu added */
	ads::Message_Queue<Ads_Job>& mq_return() { return msg_queue_; }
public:
//	int open();
	int svc();
